namespace RMIS.Binder.BackEnd
{
    ...
    /// <li>RMIS.CaseConverter.BackEnd.ICaseConverter</li>
    /// <li>RMIS.Mediator.BackEnd.ICaseConverterMediator</li>
    /// <li>RMIS.Mediator.BackEnd.IICAInterfaceMediator</li>
    /// <li>RMIS.Mediator.BackEnd.ITasklistMediator</li>
    /// <li>RMIS.Mediator.BackEnd.IFilingBrokerMediator</li>
    /// <li>RMIS.Mediator.BackEnd.IWorkflowEngineMediator</li>
    /// <li>RMIS.Mediator.BackEnd.IDataSyncMediator</li>
    /// <li>RMIS.Tasklist.BackEnd.ITasklist</li>
    /// <li>RMIS.FilingBroker.BackEnd.IFilingBrokerBackEnd</li>
    /// <li>RMIS.ExternalInterface.BackEnd.IIcaInterface</li>
    /// <li>RMIS.WorkFlowEngine.BackEnd.IWorkFlowEngine</li>
    /// <li>RMIS.DataSync.BackEnd.IDataSyncBackEnd</li>
    /// <li>RMIS.AppMon.IAppMon</li>
    /// </ol>
    /// <br/>
