...
namespace RMIS.Domain.BackEndSpecific
{
    ...
    /// </summary>
    [Serializable]
    public class ArchiveWorkitemDetailsEntity : AbstractLastModified, IBackEndSpecificEntity
    {
        #region Properties
        ...
        public string ArchiveWorkitemDetailId
        {
            get;
            set;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            ArchiveWorkitemDetailsEntity toCompareWith = obj as ArchiveWorkitemDetailsEntity;
            return toCompareWith == null ? false : ((this.ArchiveWorkitemDetailId == toCompareWith.ArchiveWorkitemDetailId) && (this.ArchiveWorkitemDetailId == toCompareWith.ArchiveWorkitemDetailId));
        }
