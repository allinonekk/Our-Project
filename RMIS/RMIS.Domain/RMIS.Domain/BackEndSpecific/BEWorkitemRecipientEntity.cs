...
namespace RMIS.Domain.BackEndSpecific
{
    ...
    /// </summary>
    [Serializable]
    public class BEWorkitemRecipientEntity : AbstractLastModified, IBackEndSpecificEntity
    {
        #region Properties
        ...
        public override bool Equals(object obj)
        {
            ...
            BEWorkitemRecipientEntity toCompareWith = obj as BEWorkitemRecipientEntity;
            return toCompareWith == null ? false : ((this.WorkflowSerialNo == toCompareWith.WorkflowSerialNo) && (this.LFID == toCompareWith.LFID));
        }
