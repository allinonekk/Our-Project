...
/*****************************************************************************************************
 * Description : This file represents a standard DocCasePartyAuthorisedOfficerDetails.
 *
 *-----------------------------------------------------------------------------------------------------
 *	                                    File History
 *-----------------------------------------------------------------------------------------------------
 ...
 *****************************************************************************************************/
// <summary>
// File: DocCasePartyAuthorisedOfficerDetailsEntity.cs
// Description: Represents a standard DocCasePartyAuthorisedOfficerDetails.
// </summary>
// <copyright file= "DocCasePartyAuthorisedOfficerDetailsEntity.cs" company="AllInOne Pte Ltd">
...
namespace RMIS.Domain.Document
{
    ...
    /// <summary>
    /// Represents a standard domain entity for DocCasePartyAuthorisedOfficerDetails.
    /// It inherits from <see cref="AbstractDocCaseParty"/>
    /// </summary>
    [Serializable]
    public class DocCasePartyAuthorisedOfficerDetailsEntity : AbstractDocCaseParty, IDocumentEntity
    {
        #region Properties
        ...
        public override bool Equals(object obj)
        {
            ...
            DocCasePartyAuthorisedOfficerDetailsEntity toCompareWith = obj as DocCasePartyAuthorisedOfficerDetailsEntity;
