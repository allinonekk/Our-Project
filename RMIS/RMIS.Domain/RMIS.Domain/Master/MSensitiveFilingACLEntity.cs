...
namespace RMIS.Domain.Master
{
    ...
    /// <summary>
    /// Represents a standard domain entity for MSensitiveFilingACL.
    /// </summary>
    [Serializable]
    public class MSensitiveFilingACLEntity : AbstractMasterInfo, IMasterEntity
    {
        #region Constructors
        ...
        /// </summary>
        public MSensitiveFilingACLEntity()
            : base()
        {
        }
        ...
        public int SensitiveFilingACLID
        {
            get; set;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            MSensitiveFilingACLEntity toCompareWith = obj as MSensitiveFilingACLEntity;
