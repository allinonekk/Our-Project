...
/*****************************************************************************************************
* Description : This file represents a standard MPrison entity.
*
*-----------------------------------------------------------------------------------------------------
*	                                    File History
*-----------------------------------------------------------------------------------------------------
...
*****************************************************************************************************/
// <summary>
// File: MPrisonEntity.cs
// Description: Represents a standard MPrison entity.
// </summary>
// <copyright file= "MPrisonEntity.cs" company="AllInOne Pte Ltd">
...
namespace RMIS.Domain.Master
{
    ...
    [Serializable]
    public class MPrisonEntity : AbstractMasterInfo, IMasterEntity
    {
        #region Properties

        /// <summary>Gets or sets the CRInd field. </summary>
        public CustodyRemand CRInd
        {
            get;
            set;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            MPrisonEntity toCompareWith = obj as MPrisonEntity;
