...
namespace RMIS.Domain.Master
{
    ...
    [Serializable]
    public class MEMSApptOutcomeEntity : AbstractMasterInfo, IMasterEntity
    {
        #region Properties

        /// <summary>Gets or sets the EMSApptOutcomeCode field. </summary>
        public System.String EMSApptOutcomeCode
        {
            get;
            set;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            MEMSApptOutcomeEntity toCompareWith = obj as MEMSApptOutcomeEntity;
