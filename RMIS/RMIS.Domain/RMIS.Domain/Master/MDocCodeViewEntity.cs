...
/*****************************************************************************************************
* Description : This file represents a standard MDocCodeView entity.
*
*-----------------------------------------------------------------------------------------------------
*	                                    File History
*-----------------------------------------------------------------------------------------------------
...
*****************************************************************************************************/
// <summary>
// File: MDocCodeViewEntity.cs
// Description: Represents a standard MDocCodeView entity.
// </summary>
// <copyright file= "MDocCodeViewEntity.cs" company="AllInOne Pte Ltd">
...
namespace RMIS.Domain.Master
{
    ...
    /// <summary>
    /// Represents a standard domain entity for MDocCodeView.
    /// </summary>
    [Serializable]
    public class MDocCodeViewEntity : AbstractMasterInfo, IMasterEntity
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the <see cref="MDocCodeView"/> class.
        /// </summary>
        public MDocCodeViewEntity()
            : base()
        {
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            MDocCodeViewEntity toCompareWith = obj as MDocCodeViewEntity;
