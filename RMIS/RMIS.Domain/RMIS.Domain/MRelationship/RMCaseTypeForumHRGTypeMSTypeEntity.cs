...
namespace RMIS.Domain.MRelationship
{
    ...
    /// <summary>Class which represents the entity 'MRelationship.RMCaseTypeForumHRGTypeMSType'</summary>
    [Serializable]
    public class RMCaseTypeForumHRGTypeMSTypeEntity : AbstractLastModified, IMasterEntity
    {
        #region Properties
