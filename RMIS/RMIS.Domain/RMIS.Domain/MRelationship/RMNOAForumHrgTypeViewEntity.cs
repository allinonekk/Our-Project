...
namespace RMIS.Domain.Master
{
    ...
    [Serializable]
    public class RMNOAForumHrgTypeViewEntity : AbstractLastModified, IMasterEntity
    {
        #region Properties
        ...
        /// <summary>Gets or sets the NOADescription field. </summary>
        public String NOADescription
        {
            get;
            set;
        }
