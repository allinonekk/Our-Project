...
namespace RMIS.Domain.SubCaseData
{
    using System;
    ...
    using RMIS.Domain.SubCaseSpecific;

    /// <summary>
    /// Represents a standard data container object for RegistrarsAppeals sub case type.
    /// </summary>
    [Serializable]
    public class RegistrarsAppealsData : ISubCaseTypeInfo
    {
        #region Properties
        ...
        public RARASInfoEntity RARASInfoEntity
        {
            get;
            set;
        }
