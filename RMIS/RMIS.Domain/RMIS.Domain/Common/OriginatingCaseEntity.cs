...
namespace RMIS.Domain.Common
{
    ...
    /// <summary>
    /// Represents a standard domain entity for OriginatingCase.
    /// It inherits from <see cref="AbstractRecIdCaseInfoSubmissionGroup"/>
    /// </summary>
    [Serializable]
    public class OriginatingCaseEntity : AbstractRecIdCaseInfoSubmissionGroup, ICommonEntity
    {
        #region Properties
        ...
        public override bool Equals(object obj)
        {
            ...
            OriginatingCaseEntity toCompareWith = obj as OriginatingCaseEntity;
