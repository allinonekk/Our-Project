...
/*****************************************************************************************************
* Description : This file represents a standard LABPartyAddress entity.
*
*-----------------------------------------------------------------------------------------------------
*	                                    File History
*-----------------------------------------------------------------------------------------------------
...
*****************************************************************************************************/
// <summary>
// File: LABPartyAddressEntity.cs
// Description: Represents a standard LABPartyAddress entity.
// </summary>
// <copyright file= "LABPartyAddressEntity.cs" company="AllInOne Pte Ltd">
// Copyright (C) 2010 AllInOne Pte Ltd. All rights reserved.
// </copyright>

#endregion Header

namespace RMIS.Domain.LAP
{
    using System;
    ...
    /// <summary>
    /// Represents a standard domain entity for LABPartyAddress.
    /// It inherits from <see cref="AbstractLABParty"/>
    /// </summary>
    [Serializable]
    public class LABPartyAddressEntity : AbstractLABParty, ILAPEntity
    {
        #region Properties
        ...
        /// <summary>
        /// Gets or sets the LABPartyAddressId field.
        /// </summary>
        /// <value>The LAB party address id.</value>
        public String LABPartyAddressId
        {
            get;
            set;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            LABPartyAddressEntity toCompareWith = obj as LABPartyAddressEntity;
            return toCompareWith == null ? false : ((this.LABPartyAddressId == toCompareWith.LABPartyAddressId));
        }
        ...
        public override int GetHashCode()
        {
            ...
            toReturn ^= this.LABPartyAddressId.GetHashCode();
            return toReturn;
        }
